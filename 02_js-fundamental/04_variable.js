...
// what are variable naming rules? is it case sensitive? is $ or _ a valid variable name?

// In js what case we use to write variable name?

// if we assign a value without let keyword what happened in bts? can we do the same in strict mode?
